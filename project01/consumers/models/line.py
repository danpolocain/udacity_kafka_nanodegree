...
class Line:
    ...
    def _handle_arrival(self, message):
        ...
        if station is None:
            logger.debug("unable to message due to missing station")
            return
    ...
    def process_message(self, message):
        ...
        if message.topic("com.company.station.arrivals.table"): # Set the conditional correctly to the stations Faust Table
            try:
        ...
        elif "TURNSTILE_SUMMARY" in message.topic(): # Set the conditional to he KSQL Turnstile Summary Topic
